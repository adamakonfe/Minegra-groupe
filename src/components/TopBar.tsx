      ...
      <div className="container-main">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            {/* Email */}
            <a href="mailto:contact@minegragroup.com" className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center transition-all duration-300 group-hover:scale-110">
                <Mail className="w-5 h-5 text-black" />
              </div>
              <span className="hidden md:inline text-sm font-medium text-white">contact@minegragroup.com</span>
            </a>
            ...
            <div className="hidden lg:flex items-center gap-3 group">
              ...
              <span className="text-sm font-medium text-white">Zone du bois - Ouaga</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              href="#"
              className="w-10 h-10 rounded-full border border-white/30 hover:bg-primary hover:border-primary transition-all duration-300 flex items-center justify-center group"
              aria-label="Facebook"
            >
