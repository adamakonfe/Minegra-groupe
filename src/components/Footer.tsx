        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src={minegraLogo} alt="MINEGRA GROUP" className="h-14 w-auto" />
              <div>
            ...
            <p className="text-secondary-foreground/70 text-sm leading-relaxed">
              Votre partenaire de confiance pour les services miniers, solutions logistiques 
              et fourniture d'énergie en Afrique.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: "Consulting", href: "/conseils" },
              ].map((service) => (
        ...
        <div className="container-wau py-6">
          <div className="flex flex-wrap justify-between items-center gap-4">
            <p className="text-sm text-secondary-foreground/50">
              © {new Date().getFullYear()} MINEGRA GROUP. Tous droits réservés.
            </p>
